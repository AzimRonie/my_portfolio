...
create table test_table (
	primary_key SERIAL not null,--datatype SERIAL : untuk auto-generate nilai secara automatik setiap kali kita masukkan rekod baru. Wajib letak not null utk memastikan nilai dalam kolum tersebut tidak boleh kosong (NULL).
...
insert into test_table (smallint_col, int_col, bigint_col, room_temperature, real_number, double_prec)
values 
	(30000,2147483647,9223372036854775807, 99.99, 54321.12345, 3.12314155)
