...
-- OPERATOR NOT, in maksudnya sama dengan
--pakai in Untuk Cari dalam Senarai Pilihan
select title, length ,rating 
from film f 
where rating in ('PG-13','NC-17')

--not in maksudnya tidak sama dengan
select title, length ,rating 
from film f 
...
--Maksudnya tajuk yang mengandungi perkataan "Ghost" di mana-mana bahagian.
--"Ghost" boleh ada di tengah, depan, atau belakang tajuk.
--% Digunakan untuk cari teks yang mengandungi perkataan tertentu.
--xleh guna in sbb kita nak cari perkataan
select title, length ,rating 
from film f 
